    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-gray-100 text-gray-900 px-6 py-20">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          <h1 className="text-6xl font-extrabold bg-gradient-to-r from-sky-700 to-blue-500 bg-clip-text text-transparent drop-shadow-sm mb-4">
            What We Offer
          </h1>
        ...
        <div className="grid gap-10 sm:grid-cols-1 md:grid-cols-2">
          {/* AWS Audit */}
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 flex gap-5 border border-blue-100 hover:border-blue-300">
            <div className="bg-blue-100 text-blue-600 p-3 rounded-xl text-2xl">
              <FaAws />
            </div>
            <div>
              <h2 className="text-xl font-semibold mb-1">Silent AWS Security Audit</h2>
          ...
          {/* PowerShell + M365 */}
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 flex gap-5 border border-green-100 hover:border-green-300">
            <div className="bg-green-100 text-green-600 p-3 rounded-xl text-2xl">
              <FaWindows />
            </div>
            <div>
              <h2 className="text-xl font-semibold mb-1">PowerShell & Microsoft 365 Automation</h2>
              <p className="text-gray-700 leading-relaxed">
          ...
          {/* App Projects */}
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 flex gap-5 border border-purple-100 hover:border-purple-300 md:col-span-2">
            <div className="bg-purple-100 text-purple-600 p-3 rounded-xl text-2xl">
              <FaRocket />
            </div>
            <div>
              <h2 className="text-xl font-semibold mb-1">App Projects & Innovation</h2>
              <p className="text-gray-700 leading-relaxed">
